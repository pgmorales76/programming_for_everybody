...
# One is a, sample, file, where we give you the sum, for your testing, and the other is the, actual,
# data you need to process, for the assignment.

# Sample data: http://py4e-data.dr-chuck.net/comments_42.html (Sum=2553)
# Actual data: http://py4e-data.dr-chuck.net/comments_2018321.html (Sum ends with 84)
...
# You need to adjust this code, to look for span tag,s and pull out the text content, of the span tag,
...
# First url, is for py4e.com. Second url, is for Coursera course.
#url = "http://py4e-data.dr-chuck.net/comments_2018321.html"
url = "http://py4e-data.dr-chuck.net/comments_2028215.html"
